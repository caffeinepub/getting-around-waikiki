  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="font-display text-xl text-muted-foreground">Loading your guide…</p>
        <p className="font-sans text-sm text-muted-foreground">Fetching transportation info from the island</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-4">
      ...
      <p className="font-sans text-sm text-muted-foreground max-w-sm text-center">
        The guide is being populated. Check back soon for tips on getting around Waikiki!
      </p>
    </div>
  );
}
